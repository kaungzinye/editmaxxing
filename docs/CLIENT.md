...
6. Inspect jobs or leave active-job polling enabled. Inspect the project for separate audio, video, and storage state. Load the server plan into the editor when analysis succeeds.
